...
# Script to repack modified firmware files into a new firmware UPT file for the R3II 2025
...
UNPACKING_AND_REPACKING_DIR="${PROJECT_ROOT}/r3ii_2025/unpacking_and_repacking"
SQUASHFS_ROOT="${UNPACKING_AND_REPACKING_DIR}/squashfs-root"
XIMAGE_PATH="${UNPACKING_AND_REPACKING_DIR}/xImage"
OUT_PKG="${UNPACKING_AND_REPACKING_DIR}/r3ii_2025.upt"
